...
Secrets for `meta-agents-demo/meta-agents-server.rs` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/meta-agents-demo/meta-agents-server.rs:dev
